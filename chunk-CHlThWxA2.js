import{A as GC,Ct as Rb,Et as Rm,G as JE,Gn as gb,Gr as ts,Hr as su,K as Jr,L as Hm,S as EH,Ur as t_,Wt as Wm,Yt as Xo,_ as Db,bi as zC,cn as _e,ei as v$1,fr as mH,gi as yf,hr as mf,k as Fy,mn as aT,ni as vb,nt as Lm,oi as wm,pr as mb,sn as _,ti as vH,un as _m,w as Eb,wn as bm,wt as Rd,xr as nt,y as Di}from"./chunk-EhB_p97E.js";import{t as I}from"./chunk-Dpbfsnpd.js";import{L as rr,U as xt,p as O,s as Js,y as Te}from"./chunk-CeHvoeK2.js";import{C as m}from"./main-4OSHSCWR.js";import{b as ze,g as ne}from"./chunk-DI6-wc3q.js";var W=[`input`];var Y=[`*`];var p={color:`accent`,clickAction:`check-indeterminate`,disabledInteractive:!1};var ee=new _(`mat-checkbox-default-options`,{providedIn:`root`,factory:()=>p});var a=(function(t){return t[t.Init=0]=`Init`,t[t.Checked=1]=`Checked`,t[t.Unchecked=2]=`Unchecked`,t[t.Indeterminate=3]=`Indeterminate`,t})(a||{});var v=class{source;checked};var ce=(()=>{class t{_elementRef=v$1(Jr);_changeDetectorRef=v$1(mH);_ngZone=v$1(_e);_animationsDisabled=xt();_options=v$1(ee,{optional:!0});focus(){this._inputElement.nativeElement.focus()}_createChangeEvent(e){let n=new v;return n.source=this,n.checked=e,n}_getAnimationTargetElement(){return this._inputElement?.nativeElement}_animationClasses={uncheckedToChecked:`mdc-checkbox--anim-unchecked-checked`,uncheckedToIndeterminate:`mdc-checkbox--anim-unchecked-indeterminate`,checkedToUnchecked:`mdc-checkbox--anim-checked-unchecked`,checkedToIndeterminate:`mdc-checkbox--anim-checked-indeterminate`,indeterminateToChecked:`mdc-checkbox--anim-indeterminate-checked`,indeterminateToUnchecked:`mdc-checkbox--anim-indeterminate-unchecked`};ariaLabel=``;ariaLabelledby=null;ariaDescribedby;ariaExpanded;ariaControls;ariaOwns;_uniqueId;id;get inputId(){return`${this.id||this._uniqueId}-input`}required=!1;labelPosition=`after`;name=null;change=new nt;indeterminateChange=new nt;value;disableRipple=!1;_inputElement;tabIndex;color;disabledInteractive;_onTouched=()=>{};_currentAnimationClass=``;_currentCheckState=a.Init;_controlValueAccessorChangeFn=()=>{};_validatorChangeFn=()=>{};constructor(){v$1(O).load(rr);let e=v$1(new Fy(`tabindex`),{optional:!0});this._options=this._options||p,this.color=this._options.color||p.color,this.tabIndex=e==null?0:parseInt(e)||0,this.id=this._uniqueId=v$1(Te).getId(`mat-mdc-checkbox-`),this.disabledInteractive=this._options?.disabledInteractive??!1}ngOnChanges(e){e.required&&this._validatorChangeFn()}ngAfterViewInit(){this._syncIndeterminate(this.indeterminate)}get checked(){return this._checked}set checked(e){e!=this.checked&&(this._checked=e,this._changeDetectorRef.markForCheck())}_checked=!1;get disabled(){return this._disabled}set disabled(e){e!==this.disabled&&(this._disabled=e,this._changeDetectorRef.markForCheck())}_disabled=!1;get indeterminate(){return this._indeterminate()}set indeterminate(e){let n=e!=this._indeterminate();this._indeterminate.set(e),n&&(e?this._transitionCheckState(a.Indeterminate):this._transitionCheckState(this.checked?a.Checked:a.Unchecked),this.indeterminateChange.emit(e)),this._syncIndeterminate(e)}_indeterminate=Di(!1);_isRippleDisabled(){return this.disableRipple||this.disabled}_onLabelTextChange(){this._changeDetectorRef.detectChanges()}writeValue(e){this.checked=!!e}registerOnChange(e){this._controlValueAccessorChangeFn=e}registerOnTouched(e){this._onTouched=e}setDisabledState(e){this.disabled=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorChangeFn=e}_transitionCheckState(e){let n=this._currentCheckState,c=this._getAnimationTargetElement();if(!(n===e||!c)&&(this._currentAnimationClass&&c.classList.remove(this._currentAnimationClass),this._currentAnimationClass=this._getAnimationClassForCheckStateTransition(n,e),this._currentCheckState=e,this._currentAnimationClass.length>0)){c.classList.add(this._currentAnimationClass);let o=this._currentAnimationClass;this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{c.classList.remove(o)},1e3)})}}_emitChangeEvent(){this._controlValueAccessorChangeFn(this.checked),this.change.emit(this._createChangeEvent(this.checked)),this._inputElement&&(this._inputElement.nativeElement.checked=this.checked)}toggle(){this.checked=!this.checked,this._controlValueAccessorChangeFn(this.checked)}_handleInputClick(){let e=this._options?.clickAction;!this.disabled&&e!==`noop`?(this.indeterminate&&e!==`check`&&Promise.resolve().then(()=>{this._indeterminate.set(!1),this.indeterminateChange.emit(!1)}),this._checked=!this._checked,this._transitionCheckState(this._checked?a.Checked:a.Unchecked),this._emitChangeEvent()):(this.disabled&&this.disabledInteractive||!this.disabled&&e===`noop`)&&(this._inputElement.nativeElement.checked=this.checked,this._inputElement.nativeElement.indeterminate=this.indeterminate)}_onInteractionEvent(e){e.stopPropagation()}_onBlur(){Promise.resolve().then(()=>{this._onTouched(),this._changeDetectorRef.markForCheck()})}_getAnimationClassForCheckStateTransition(e,n){if(this._animationsDisabled)return``;switch(e){case a.Init:if(n===a.Checked)return this._animationClasses.uncheckedToChecked;if(n==a.Indeterminate)return this._checked?this._animationClasses.checkedToIndeterminate:this._animationClasses.uncheckedToIndeterminate;break;case a.Unchecked:return n===a.Checked?this._animationClasses.uncheckedToChecked:this._animationClasses.uncheckedToIndeterminate;case a.Checked:return n===a.Unchecked?this._animationClasses.checkedToUnchecked:this._animationClasses.checkedToIndeterminate;case a.Indeterminate:return n===a.Checked?this._animationClasses.indeterminateToChecked:this._animationClasses.indeterminateToUnchecked}return``}_syncIndeterminate(e){let n=this._inputElement;n&&(n.nativeElement.indeterminate=e)}_onInputClick(){this._handleInputClick()}_preventBubblingFromLabel(e){e.target&&this._inputElement&&e.target!==this._inputElement.nativeElement&&e.stopPropagation()}static ɵfac=function(n){return new(n||t)};static ɵcmp=GC({type:t,selectors:[[`mat-checkbox`]],viewQuery:function(n,c){if(n&1&&Hm(W,5),n&2){let o;vb(o=Eb())&&(c._inputElement=o.first)}},hostAttrs:[1,`mat-mdc-checkbox`],hostVars:16,hostBindings:function(n,c){n&2&&(Rm(`id`,c.id),wm(`tabindex`,null)(`aria-label`,null)(`aria-labelledby`,null),Rb(c.color?`mat-`+c.color:`mat-accent`),Wm(`_mat-animation-noopable`,c._animationsDisabled)(`mdc-checkbox--disabled`,c.disabled)(`mat-mdc-checkbox-disabled`,c.disabled)(`mat-mdc-checkbox-checked`,c.checked)(`mat-mdc-checkbox-disabled-interactive`,c.disabledInteractive))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],ariaExpanded:[2,`aria-expanded`,`ariaExpanded`,vH],ariaControls:[0,`aria-controls`,`ariaControls`],ariaOwns:[0,`aria-owns`,`ariaOwns`],id:`id`,required:[2,`required`,`required`,vH],labelPosition:`labelPosition`,name:`name`,value:`value`,disableRipple:[2,`disableRipple`,`disableRipple`,vH],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?void 0:EH(e)],color:`color`,disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,vH],checked:[2,`checked`,`checked`,vH],disabled:[2,`disabled`,`disabled`,vH],indeterminate:[2,`indeterminate`,`indeterminate`,vH]},outputs:{change:`change`,indeterminateChange:`indeterminateChange`},exportAs:[`matCheckbox`],features:[t_([{provide:ze,useExisting:Xo(()=>t),multi:!0},{provide:ne,useExisting:t,multi:!0}]),JE],ngContentSelectors:Y,decls:15,vars:23,consts:[[`checkbox`,``],[`input`,``],[`label`,``],[`mat-internal-form-field`,``,3,`click`,`labelPosition`,`for`],[1,`mdc-checkbox`],[`aria-hidden`,`true`,1,`mat-mdc-checkbox-touch-target`],[`type`,`checkbox`,1,`mdc-checkbox__native-control`,3,`blur`,`click`,`change`,`checked`,`indeterminate`,`disabled`,`id`,`required`,`tabIndex`],[`aria-hidden`,`true`,1,`mdc-checkbox__ripple`],[`aria-hidden`,`true`,1,`mdc-checkbox__background`],[`focusable`,`false`,`viewBox`,`0 0 24 24`,1,`mdc-checkbox__checkmark`],[`fill`,`none`,`d`,`M1.73,12.91 8.1,19.28 22.79,4.59`,1,`mdc-checkbox__checkmark-path`],[1,`mdc-checkbox__mixedmark`],[`mat-ripple`,``,`aria-hidden`,`true`,1,`mat-mdc-checkbox-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mat-internal-form-field-label`,`mdc-label`]],template:function(n,c){if(n&1&&(gb(),ts(0,`label`,3),Lm(`click`,function(h){return c._preventBubblingFromLabel(h)}),ts(1,`span`,4,0),_m(3,`span`,5),ts(4,`input`,6,1),Lm(`blur`,function(){return c._onBlur()})(`click`,function(){return c._onInputClick()})(`change`,function(h){return c._onInteractionEvent(h)}),su(),_m(6,`span`,7),ts(7,`span`,8),mf(),ts(8,`svg`,9),_m(9,`path`,10),su(),yf(),_m(10,`span`,11),su(),_m(11,`span`,12),su(),ts(12,`span`,13,2),mb(14),su()()),n&2){let o=Db(2);bm(`labelPosition`,c.labelPosition)(`for`,c.inputId),aT(4),Wm(`mdc-checkbox--selected`,c.checked),bm(`checked`,c.checked)(`indeterminate`,c.indeterminate)(`disabled`,c.disabled&&!c.disabledInteractive)(`id`,c.inputId)(`required`,c.required)(`tabIndex`,c.disabled&&!c.disabledInteractive?-1:c.tabIndex),wm(`aria-label`,c.ariaLabel||null)(`aria-labelledby`,c.ariaLabelledby)(`aria-describedby`,c.ariaDescribedby)(`aria-checked`,c.indeterminate?`mixed`:null)(`aria-controls`,c.ariaControls)(`aria-disabled`,c.disabled&&c.disabledInteractive?!0:null)(`aria-expanded`,c.ariaExpanded)(`aria-owns`,c.ariaOwns)(`name`,c.name)(`value`,c.value),aT(7),bm(`matRippleTrigger`,o)(`matRippleDisabled`,c.disableRipple||c.disabled)(`matRippleCentered`,!0)}},dependencies:[Js,m],styles:[`.mdc-checkbox {
...
`],encapsulation:2})}return t})();var pe=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=zC({type:t});static ɵinj=Rd({imports:[ce,I]})}return t})();export{pe as n,ce as t};