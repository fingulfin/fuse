import{A as GC,Ar as pb,Gn as gb,Gr as ts,Hr as su,K as Jr,L as Hm,Ur as t_,Wt as Wm,Yt as Xo,_ as Db,bi as zC,ei as v,fr as mH,k as Fy,mn as aT,ni as vb,nn as ZC,nt as Lm,oi as wm,pr as mb,sn as _,ti as vH,tn as Yw,un as _m,w as Eb,wn as bm,wt as Rd,xr as nt$1,xt as Qw,y as Di,zt as Vm}from"./chunk-EhB_p97E.js";import{n as m$1,t as I}from"./chunk-Dpbfsnpd.js";import{L as rr,M as mt,P as nr,U as xt,h as Ot,p as O,s as Js,y as Te}from"./chunk-CeHvoeK2.js";import{N as i}from"./main-3H7AHLJQ.js";import{t as d}from"./chunk-KMIcC_Pp.js";import{_ as ze}from"./chunk-DTUD0a3C.js";var gt=[`button`];var dt=[`*`];function ct(o,x){if(o&1&&(ts(0,`div`,2),_m(1,`mat-pseudo-checkbox`,6),su()),o&2){let t=pb();aT(),bm(`disabled`,t.disabled)}}var tt=new _(`MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS`,{providedIn:`root`,factory:()=>({hideSingleSelectionIndicator:!1,hideMultipleSelectionIndicator:!1,disabledInteractive:!1})});var et=new _(`MatButtonToggleGroup`);var ut={provide:ze,useExisting:Xo(()=>bt),multi:!0};var m=class{source;value;constructor(x,t){this.source=x,this.value=t}};var bt=(()=>{class o{_changeDetector=v(mH);_dir=v(m$1,{optional:!0});_multiple=!1;_disabled=!1;_disabledInteractive=!1;_selectionModel;_rawValue;_controlValueAccessorChangeFn=()=>{};_onTouched=()=>{};_buttonToggles;appearance;get name(){return this._name}set name(t){this._name=t,this._markButtonsForCheck()}_name=v(Te).getId(`mat-button-toggle-group-`);vertical=!1;get value(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t.map(n=>n.value):t[0]?t[0].value:void 0}set value(t){this._setSelectionByValue(t),this.valueChange.emit(this.value)}valueChange=new nt$1;get selected(){let t=this._selectionModel?this._selectionModel.selected:[];return this.multiple?t:t[0]||null}get multiple(){return this._multiple}set multiple(t){this._multiple=t,this._markButtonsForCheck()}get disabled(){return this._disabled}set disabled(t){this._disabled=t,this._markButtonsForCheck()}get disabledInteractive(){return this._disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t,this._markButtonsForCheck()}get dir(){return this._dir&&this._dir.value===`rtl`?`rtl`:`ltr`}change=new nt$1;get hideSingleSelectionIndicator(){return this._hideSingleSelectionIndicator}set hideSingleSelectionIndicator(t){this._hideSingleSelectionIndicator=t,this._markButtonsForCheck()}_hideSingleSelectionIndicator;get hideMultipleSelectionIndicator(){return this._hideMultipleSelectionIndicator}set hideMultipleSelectionIndicator(t){this._hideMultipleSelectionIndicator=t,this._markButtonsForCheck()}_hideMultipleSelectionIndicator;constructor(){let t=v(tt,{optional:!0});this.appearance=t&&t.appearance?t.appearance:`standard`,this._hideSingleSelectionIndicator=t?.hideSingleSelectionIndicator??!1,this._hideMultipleSelectionIndicator=t?.hideMultipleSelectionIndicator??!1}ngOnInit(){this._selectionModel=new d(this.multiple,void 0,!1)}ngAfterContentInit(){this._selectionModel.select(...this._buttonToggles.filter(t=>t.checked)),this.multiple||this._initializeTabIndex()}writeValue(t){this.value=t,this._changeDetector.markForCheck()}registerOnChange(t){this._controlValueAccessorChangeFn=t}registerOnTouched(t){this._onTouched=t}setDisabledState(t){this.disabled=t}_keydown(t){if(this.multiple||this.disabled||Ot(t))return;let e=t.target.id,a=this._buttonToggles.toArray().findIndex(s=>s.buttonId===e),l=null;switch(t.keyCode){case 32:case 13:l=this._buttonToggles.get(a)||null;break;case 38:l=this._getNextButton(a,-1);break;case 37:l=this._getNextButton(a,this.dir===`ltr`?-1:1);break;case 40:l=this._getNextButton(a,1);break;case 39:l=this._getNextButton(a,this.dir===`ltr`?1:-1);break;default:return}l&&(t.preventDefault(),l._onButtonClick(),l.focus())}_emitChangeEvent(t){let n=new m(t,this.value);this._rawValue=n.value,this._controlValueAccessorChangeFn(n.value),this.change.emit(n)}_syncButtonToggle(t,n,e=!1,a=!1){!this.multiple&&this.selected&&!t.checked&&(this.selected.checked=!1),this._selectionModel?n?this._selectionModel.select(t):this._selectionModel.deselect(t):a=!0,a?Promise.resolve().then(()=>this._updateModelValue(t,e)):this._updateModelValue(t,e)}_isSelected(t){return this._selectionModel&&this._selectionModel.isSelected(t)}_isPrechecked(t){return typeof this._rawValue>`u`?!1:this.multiple&&Array.isArray(this._rawValue)?this._rawValue.some(n=>t.value!=null&&n===t.value):t.value===this._rawValue}_initializeTabIndex(){if(this._buttonToggles.forEach(t=>{t.tabIndex=-1}),this.selected)this.selected.tabIndex=0;else for(let t=0;t<this._buttonToggles.length;t++){let n=this._buttonToggles.get(t);if(!n.disabled){n.tabIndex=0;break}}}_getNextButton(t,n){let e=this._buttonToggles;for(let a=1;a<=e.length;a++){let l=(t+n*a+e.length)%e.length,s=e.get(l);if(s&&!s.disabled)return s}return null}_setSelectionByValue(t){if(this._rawValue=t,!this._buttonToggles)return;let n=this._buttonToggles.toArray();if(this.multiple&&t?(this._clearSelection(),t.forEach(e=>this._selectValue(e,n))):(this._clearSelection(),this._selectValue(t,n)),!this.multiple&&n.every(e=>e.tabIndex===-1)){for(let e of n)if(!e.disabled){e.tabIndex=0;break}}}_clearSelection(){this._selectionModel.clear(),this._buttonToggles.forEach(t=>{t.checked=!1,this.multiple||(t.tabIndex=-1)})}_selectValue(t,n){for(let e of n)if(e.value===t){e.checked=!0,this._selectionModel.select(e),this.multiple||(e.tabIndex=0);break}}_updateModelValue(t,n){n&&this._emitChangeEvent(t),this.valueChange.emit(this.value)}_markButtonsForCheck(){this._buttonToggles?.forEach(t=>t._markForCheck())}static ɵfac=function(n){return new(n||o)};static ɵdir=ZC({type:o,selectors:[[`mat-button-toggle-group`]],contentQueries:function(n,e,a){if(n&1&&Vm(a,nt,5),n&2){let l;vb(l=Eb())&&(e._buttonToggles=l)}},hostAttrs:[1,`mat-button-toggle-group`],hostVars:6,hostBindings:function(n,e){n&1&&Lm(`keydown`,function(l){return e._keydown(l)}),n&2&&(wm(`role`,e.multiple?`group`:`radiogroup`)(`aria-disabled`,e.disabled),Wm(`mat-button-toggle-vertical`,e.vertical)(`mat-button-toggle-group-appearance-standard`,e.appearance===`standard`))},inputs:{appearance:`appearance`,name:`name`,vertical:[2,`vertical`,`vertical`,vH],value:`value`,multiple:[2,`multiple`,`multiple`,vH],disabled:[2,`disabled`,`disabled`,vH],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,vH],hideSingleSelectionIndicator:[2,`hideSingleSelectionIndicator`,`hideSingleSelectionIndicator`,vH],hideMultipleSelectionIndicator:[2,`hideMultipleSelectionIndicator`,`hideMultipleSelectionIndicator`,vH]},outputs:{valueChange:`valueChange`,change:`change`},exportAs:[`matButtonToggleGroup`],features:[t_([ut,{provide:et,useExisting:o}])]})}return o})();var nt=(()=>{class o{_changeDetectorRef=v(mH);_elementRef=v(Jr);_focusMonitor=v(mt);_idGenerator=v(Te);_animationDisabled=xt();_checked=!1;ariaLabel;ariaLabelledby=null;_buttonElement;buttonToggleGroup;get buttonId(){return`${this.id}-button`}id;name;value;get tabIndex(){return this._tabIndex()}set tabIndex(t){this._tabIndex.set(t)}_tabIndex;disableRipple=!1;get appearance(){return this.buttonToggleGroup?this.buttonToggleGroup.appearance:this._appearance}set appearance(t){this._appearance=t}_appearance;get checked(){return this.buttonToggleGroup?this.buttonToggleGroup._isSelected(this):this._checked}set checked(t){t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&this.buttonToggleGroup._syncButtonToggle(this,this._checked),this._changeDetectorRef.markForCheck())}get disabled(){return this._disabled||this.buttonToggleGroup&&this.buttonToggleGroup.disabled}set disabled(t){this._disabled=t}_disabled=!1;get disabledInteractive(){return this._disabledInteractive||this.buttonToggleGroup!==null&&this.buttonToggleGroup.disabledInteractive}set disabledInteractive(t){this._disabledInteractive=t}_disabledInteractive;change=new nt$1;constructor(){v(O).load(rr);let t=v(et,{optional:!0}),n=v(new Fy(`tabindex`),{optional:!0})||``,e=v(tt,{optional:!0});this._tabIndex=Di(parseInt(n)||0),this.buttonToggleGroup=t,this._appearance=e&&e.appearance?e.appearance:`standard`,this._disabledInteractive=e?.disabledInteractive??!1}ngOnInit(){let t=this.buttonToggleGroup;this.id=this.id||this._idGenerator.getId(`mat-button-toggle-`),t&&(t._isPrechecked(this)?this.checked=!0:t._isSelected(this)!==this._checked&&t._syncButtonToggle(this,this._checked))}ngAfterViewInit(){this._animationDisabled||this._elementRef.nativeElement.classList.add(`mat-button-toggle-animations-enabled`),this._focusMonitor.monitor(this._elementRef,!0)}ngOnDestroy(){let t=this.buttonToggleGroup;this._focusMonitor.stopMonitoring(this._elementRef),t&&t._isSelected(this)&&t._syncButtonToggle(this,!1,!1,!0)}focus(t){this._buttonElement.nativeElement.focus(t)}_onButtonClick(){if(this.disabled)return;let t=this.isSingleSelector()?!0:!this._checked;if(t!==this._checked&&(this._checked=t,this.buttonToggleGroup&&(this.buttonToggleGroup._syncButtonToggle(this,this._checked,!0),this.buttonToggleGroup._onTouched())),this.isSingleSelector()){let n=this.buttonToggleGroup._buttonToggles.find(e=>e.tabIndex===0);n&&(n.tabIndex=-1),this.tabIndex=0}this.change.emit(new m(this,this.value))}_markForCheck(){this._changeDetectorRef.markForCheck()}_getButtonName(){return this.isSingleSelector()?this.buttonToggleGroup.name:this.name||null}isSingleSelector(){return this.buttonToggleGroup&&!this.buttonToggleGroup.multiple}static ɵfac=function(n){return new(n||o)};static ɵcmp=GC({type:o,selectors:[[`mat-button-toggle`]],viewQuery:function(n,e){if(n&1&&Hm(gt,5),n&2){let a;vb(a=Eb())&&(e._buttonElement=a.first)}},hostAttrs:[`role`,`presentation`,1,`mat-button-toggle`],hostVars:14,hostBindings:function(n,e){n&1&&Lm(`focus`,function(){return e.focus()}),n&2&&(wm(`aria-label`,null)(`aria-labelledby`,null)(`id`,e.id)(`name`,null),Wm(`mat-button-toggle-standalone`,!e.buttonToggleGroup)(`mat-button-toggle-checked`,e.checked)(`mat-button-toggle-disabled`,e.disabled)(`mat-button-toggle-disabled-interactive`,e.disabledInteractive)(`mat-button-toggle-appearance-standard`,e.appearance===`standard`))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],id:`id`,name:`name`,value:`value`,tabIndex:`tabIndex`,disableRipple:[2,`disableRipple`,`disableRipple`,vH],appearance:`appearance`,checked:[2,`checked`,`checked`,vH],disabled:[2,`disabled`,`disabled`,vH],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,vH]},outputs:{change:`change`},exportAs:[`matButtonToggle`],ngContentSelectors:dt,decls:7,vars:13,consts:[[`button`,``],[`type`,`button`,1,`mat-button-toggle-button`,`mat-focus-indicator`,3,`click`,`id`,`disabled`],[1,`mat-button-toggle-checkbox-wrapper`],[1,`mat-button-toggle-label-content`],[1,`mat-button-toggle-focus-overlay`],[`matRipple`,``,1,`mat-button-toggle-ripple`,3,`matRippleTrigger`,`matRippleDisabled`],[`state`,`checked`,`aria-hidden`,`true`,`appearance`,`minimal`,3,`disabled`]],template:function(n,e){if(n&1&&(gb(),ts(0,`button`,1,0),Lm(`click`,function(){return e._onButtonClick()}),Qw(2,ct,2,1,`div`,2),ts(3,`span`,3),mb(4),su()(),_m(5,`span`,4)(6,`span`,5)),n&2){let a=Db(1);bm(`id`,e.buttonId)(`disabled`,e.disabled&&!e.disabledInteractive||null),wm(`role`,e.isSingleSelector()?`radio`:`button`)(`tabindex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`aria-pressed`,e.isSingleSelector()?null:e.checked)(`aria-checked`,e.isSingleSelector()?e.checked:null)(`name`,e._getButtonName())(`aria-label`,e.ariaLabel)(`aria-labelledby`,e.ariaLabelledby)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),aT(2),Yw(e.buttonToggleGroup&&(!e.buttonToggleGroup.multiple&&!e.buttonToggleGroup.hideSingleSelectionIndicator||e.buttonToggleGroup.multiple&&!e.buttonToggleGroup.hideMultipleSelectionIndicator)?2:-1),aT(4),bm(`matRippleTrigger`,a)(`matRippleDisabled`,e.disableRipple||e.disabled)}},dependencies:[Js,i],styles:[`.mat-button-toggle-standalone,
...
`],encapsulation:2})}return o})();var Dt=(()=>{class o{static ɵfac=function(n){return new(n||o)};static ɵmod=zC({type:o});static ɵinj=Rd({imports:[nr,nt,I]})}return o})();export{bt as n,nt as r,Dt as t};