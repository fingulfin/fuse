import{A as GC,Ct as Rb,Et as Rm,G as JE,Gn as gb,Gr as ts,Hr as su,K as Jr,L as Hm,S as EH,Ur as t_,Wt as Wm,Yt as Xo,_ as Db,bi as zC,ei as v,fr as mH,hr as mf,k as Fy,mn as aT,ni as vb,nt as Lm,oi as wm,pr as mb,sn as _,ti as vH,tn as Yw,un as _m,w as Eb,wn as bm,wt as Rd,xr as nt,xt as Qw}from"./chunk-EhB_p97E.js";import{t as I}from"./chunk-Dpbfsnpd.js";import{L as rr,M as mt,U as xt,p as O,s as Js,y as Te}from"./chunk-CeHvoeK2.js";import{C as m}from"./main-3H7AHLJQ.js";import{_ as ze,p as ne}from"./chunk-DTUD0a3C.js";var Y=[`switch`];var J=[`*`];function K(i,p){i&1&&(ts(0,`span`,11),mf(),ts(1,`svg`,13),_m(2,`path`,14),su(),ts(3,`svg`,15),_m(4,`path`,16),su()())}var ee=new _(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var g=class{source;checked;constructor(p,t){this.source=p,this.checked=t}};var te=(()=>{class i{_elementRef=v(Jr);_focusMonitor=v(mt);_changeDetectorRef=v(mH);defaults=v(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new g(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=xt();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new nt;toggleChange=new nt;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){v(O).load(rr);let t=v(new Fy(`tabindex`),{optional:!0}),a=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=a.color||`accent`,this.id=this._uniqueId=v(Te).getId(`mat-mdc-slide-toggle-`),this.hideIcon=a.hideIcon??!1,this.disabledInteractive=a.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new g(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(a){return new(a||i)};static ɵcmp=GC({type:i,selectors:[[`mat-slide-toggle`]],viewQuery:function(a,e){if(a&1&&Hm(Y,5),a&2){let l;vb(l=Eb())&&(e._switchElement=l.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(a,e){a&2&&(Rm(`id`,e.id),wm(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),Rb(e.color?`mat-`+e.color:``),Wm(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,vH],color:`color`,disabled:[2,`disabled`,`disabled`,vH],fullWidth:[2,`fullWidth`,`fullWidth`,vH],disableRipple:[2,`disableRipple`,`disableRipple`,vH],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:EH(t)],checked:[2,`checked`,`checked`,vH],hideIcon:[2,`hideIcon`,`hideIcon`,vH],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,vH]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[t_([{provide:ze,useExisting:Xo(()=>i),multi:!0},{provide:ne,useExisting:i,multi:!0}]),JE],ngContentSelectors:J,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(a,e){if(a&1&&(gb(),ts(0,`div`,1)(1,`button`,2,0),Lm(`click`,function(){return e._handleClick()}),_m(3,`div`,3)(4,`span`,4),ts(5,`span`,5)(6,`span`,6)(7,`span`,7),_m(8,`span`,8),su(),ts(9,`span`,9),_m(10,`span`,10),su(),Qw(11,K,5,0,`span`,11),su()()(),ts(12,`label`,12),Lm(`click`,function($){return $.stopPropagation()}),mb(13),su()()),a&2){let l=Db(2);bm(`labelPosition`,e.labelPosition),aT(),Wm(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),bm(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),wm(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),aT(9),bm(`matRippleTrigger`,l)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),aT(),Yw(e.hideIcon?-1:11),aT(),bm(`for`,e.buttonId),wm(`id`,e._labelId)}},dependencies:[Js,m],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return i})();var we=(()=>{class i{static ɵfac=function(a){return new(a||i)};static ɵmod=zC({type:i});static ɵinj=Rd({imports:[te,I]})}return i})();export{we as n,te as t};